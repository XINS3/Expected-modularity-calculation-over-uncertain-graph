...
node, edge_position, edge_possibility=load_graph('datasets/3Community9nodes_each0.72within0.12between.npy')
com=load_com('datasets/3Community9nodes_each0.72within0.12between_cluster.npy')
...
plt.scatter(x,S1,marker='o',c='r',s=100,label=r'$APWP^{EMOD}$')
plt.scatter(x,S2_mean,marker='^',c='b',s=100,label='Threshold method')
...
ax.legend(loc='lower center', bbox_to_anchor=(0.8, 0.2),prop={'size': 8})

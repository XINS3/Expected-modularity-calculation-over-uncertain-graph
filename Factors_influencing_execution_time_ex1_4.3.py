...
Cring=SizeVariance_Commuinity(5, 100 ,19)

T_2=[]
for i in np.arange(0,len(Cring),2):
    S_t=0
    for j in range(3):
...
# draw
T=[T_2[x] for x in np.arange(1,len(T_2),2)]
# draw

from matplotlib.patches import Rectangle
species = ( "[18,18,18,18,28]", '[14,14,14,14,44]','[10,10,10,10,60]'
          ,'[6,6,6,6,76]','[2,2,2,2,92]')
penguin_means = {
    'FFN': (161.576),

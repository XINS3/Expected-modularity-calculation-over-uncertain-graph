...
node, edge_position, edge_possibility=load_graph('3Community9nodes_each0.72within0.12between.npy')
com=load_com('3Community9nodes_each0.72within0.12between_cluster.npy')
...
plt.title('Entropy ratio=0.47')
plt.savefig('sampling_lccs_0.47.pdf')
plt.show()
